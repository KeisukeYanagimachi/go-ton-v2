...
- 来社枠の一覧と編集を分離する
- 必須項目は starts_at / ends_at / capacity のみ
- 作成・編集は ADMIN のみが実行できることを明示する

### 3.12 Candidate の来社割当

#### 前提状態

- 何をしたいか: Candidate を来社枠に割り当てたい
- 何を知らないか: どの枠に空きがあるか
- 不安: 定員超過や誤割当
